...
import com.ute.foodiedash.infrastructure.persistence.restaurant.jpa.mapper.RestaurantJpaMapper;
import com.ute.foodiedash.infrastructure.persistence.restaurant.jpa.repository.RestaurantJpaRepository;
...
public class RestaurantRepositoryAdapter implements RestaurantRepository {
    ...
    public Restaurant save(Restaurant restaurant) {
        RestaurantJpaEntity jpaEntity;
        if (restaurant.getId() == null) {
            jpaEntity = mapper.toJpaEntity(restaurant);
        } else {
            jpaEntity = jpaRepository.findById(restaurant.getId())
                    .orElseThrow();
