...
import com.ute.foodiedash.infrastructure.persistence.restaurant.jpa.mapper.RestaurantRatingJpaMapper;
import com.ute.foodiedash.infrastructure.persistence.restaurant.jpa.repository.RestaurantRatingJpaRepository;
...
public class RestaurantRatingRepositoryAdapter implements RestaurantRatingRepository {
    ...
    public RestaurantRating save(RestaurantRating restaurantRating) {
        RestaurantRatingJpaEntity jpaEntity = jpaRepository.findById(restaurantRating.getId())
                .orElseThrow();
